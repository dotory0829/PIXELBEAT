const MyPageBillButton = ({
	...
	return (
		<button
			...
			className={
				propsClass
					? `${propsClass} relative block w-full`
		...
		>
			...
			>
				<mask id="path-1-inside-1_1345_20885" fill="white">
					<path
						fillRule="evenodd"
						clipRule="evenodd"
			...
			<span
				className="absolute left-[50%] top-[50%] w-full translate-x-[-50%] translate-y-[-40%] transform pl-6 text-18"
...
export default MyPageBillButton;
